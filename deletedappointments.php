...
$linkpage = 'deletedappointments.php';
$changecustomer = '0';
...
$sql2 = 'SELECT * FROM `'.$locschedule.'` WHERE `thread` IS NULL AND `voiddate` IS NOT NULL ORDER BY `date` DESC';
	...
	echo "<tr><td>".$appointmentdate."</td><td><b>".$abvname."</b></td><td>".$abvvehicle."</td><td><a href=\"appointment.php?invoiceid=".$scheduleid."&change=3\" class=\"no-decoration\"><input type=\"button\" value=\"Details\">".$displayicons."</a></td><td><a href=\"schedule.php?id=".$scheduleid."&change=1\" class=\"no-decoration\"><img src=\"images/icons/schedulechange.png\" width=\"25\"></a></td></tr>";
	}
	}
		?>
</tbody></table></div>
