...
?>
        ...
        <div id="content">
<form name="enterpayment" action="printinvoice-change.php" method="POST"><table class="paymenttable">
    ...
    <div id="totalpayments"></div></td></tr>
...
<tr id="change"></tr>
<tr><td><center><input type="submit" class="smallbutton" alt="enterpayment" value="Save & Close" name="noprint"></center></td><td><input type="submit" class="smallbutton" alt="enterpayment" value="Save & Print" name="print2"></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><input type="hidden" name="accountid" value="<?php echo $accountid; ?>"><input type="hidden" name="invoiceid" value="<?php echo $invoiceid; ?>"><input type="hidden" name="vehicleid" value="<?php echo $vehicleid; ?>"><center><input type="submit" class="smallbutton" alt="enterpayment" value="1 Copy" name="print1"></center></td><td><input type="hidden" name="enterpayment" value="1"><input type="submit" class="smallbutton" alt="enterpayment" value="3 Copies" name="print3"></td></tr></table></form>
...
input.onkeyup = function() {
       ...
       document.getElementById("totalpayments").innerHTML = "Payment Amount: " + result;
}
var input1a = document.getElementById('cash');
input1a.onfocus = function() {
       var txtcash = document.getElementById('cash').value;
       var txtcheck = document.getElementById('check').value;
       var txtcc1 = document.getElementById('cc1').value;
       var txtcc2 = document.getElementById('cc2').value;
