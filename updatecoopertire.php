...
$sth4 = $pdocxn->prepare('UPDATE `inventory_price` SET `baseprice`=:baseprice,`price1`=:price1 WHERE `article` = :article AND `manid` = :manid');
$sth4->bindParam(':baseprice',$baseprice);
$sth4->bindParam(':price1',$price1);
$sth4->bindParam(':article',$article);
$sth4->bindParam(':manid',$manid);
$sth4->execute();
